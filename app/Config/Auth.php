...
//        'jwt',
     ...
     */
    public array $personalFields = ['avatar', 'first_name', 'last_name', 'birthdate'];
    ...
    {
        $session = session();
        $url     = $session->getTempdata('beforeLoginUrl') ?? setting('Auth.redirects')['user/login'];
    ...
    {
        $url = setting('Auth.redirects')['user/logout'];
    ...
    {
        $url = setting('Auth.redirects')['user/register'];
    ...
    {
        $url = setting('Auth.redirects')['user/force_reset'];
    ...
    {
        $url = setting('Auth.redirects')['user/permission_denied'];
    ...
    {
        $url = setting('Auth.redirects')['user/group_denied'];
