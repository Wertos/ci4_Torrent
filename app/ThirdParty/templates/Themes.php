...
class Themes 
{
	...
	{
		helper('themes');
		return is_file(FCPATH . self::$config[THEME_PATH] . DIRECTORY_SEPARATOR . self::$config[THEME] . DIRECTORY_SEPARATOR . validate_ext($template));
	}
