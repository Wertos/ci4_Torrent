...
class NewsController extends \App\Controllers\AdminController
{
	...
	public function NewsList()
	{
		helper('torrent');
		$pager = service('pager');
		$news = $this->NewsModel->asObject()->withDeleted(true)->orderBy('attached', 'DESC')->orderBy('created_at', 'DESC')->paginate(setting('Torrent.newsPerAdminList'));
	...
	public function NewsEditView($id)
	{
		...
		$data = [ 'page_title' => $siteTitle, 'news' => $news, ];
