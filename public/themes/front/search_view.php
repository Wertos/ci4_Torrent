...
<table class="table table-bordered table-striped table-sm table-hover">
  <thead>
    <tr>
      ...
      <th scope="col" class="bg-secondary col-1 p-2 text-center"><?= lang('Browse.torrent'); ?></th>
    </tr>
  </thead>
  <tbody>
  <?php
  ...
  ?>
    <tr>
      ...
      <td class="pt-2 pb-2 text-center align-middle small">
      	<span class="text-success" title="<?= lang('Browse.seed'); ?>"><?= number_format($tor->seed) ?? 0; ?></span>
