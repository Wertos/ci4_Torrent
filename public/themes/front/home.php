  ...
  <div class="col-xs-12 col-sm-4 col-lg-6 mb-4">
   ...
   <!-- Default panel contents -->
    ...
    <div class="list-group list-group-flush" id="catid_<?php echo $cat->id; ?>">
		...
		<div class="border ' . $status['class'] . ' pt-1 pe-2 pb-1 ps-2 align-self-center position-absolute top-0 start-100 translate-middle badge bg-secondary">' . $status['icon'] . ' '.getStrTorrVersion($torrent->version).'</div>
	';?>
