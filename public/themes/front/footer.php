<?php defined('APPPATH') OR exit('No direct script access allowed'); ?>
				...
				<div class="col-3">
					...
					<?php if($widgets['category']) : ?>
					  <?php include "widget/category.php"; ?>
					<?php endif; ?>
					<?php if($widgets['stats']) : ?>
					  <?php include "widget/stats.php"; ?>
					<?php endif; ?>
				</div>
			</div>
   </div>
